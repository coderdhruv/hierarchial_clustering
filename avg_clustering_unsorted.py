...
"""function to find the find the average distance between two data points,(they could be in
...
plt.ylabel('Distance')
augmented_dendrogram(tmpZ, labels=names, show_leaf_counts=True, p=150, truncate_mode='lastp')
plt.show()